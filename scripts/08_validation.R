...
invisible(iwalk(plots_by_method, function(p, mth) {
  ggsave(paste0("figures/external-validation/validation_png/obs_pred_external_", mth, ".png"),  p, width = 8, height = 6, dpi = 300)
  ggsave(paste0("figures/external-validation/validation_tiff/obs_pred_external_", mth, ".tiff"), p, width = 8, height = 6, dpi = 300, compression = "lzw")
}))
...
print(doc, target = "docx/external-validation/performance_validation_by_set.docx")
