...
| 05_prediction-ec-ph-log.R | Fits linear models to predict chloride methods using logSP, with optional covariates (pH, EC) and tests them on a 20% holdout set                  |
